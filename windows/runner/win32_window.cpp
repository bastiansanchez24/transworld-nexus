...
void Win32Window::UpdateTheme(HWND const window) {
  // La app es siempre clara: el caption nativo debe calzar con el contenedor
  // (#F2F5F9) y no seguir el tema oscuro del sistema.
  BOOL enable_dark_mode = FALSE;
  DwmSetWindowAttribute(window, DWMWA_USE_IMMERSIVE_DARK_MODE,
                        &enable_dark_mode, sizeof(enable_dark_mode));

  COLORREF caption_color = RGB(0xF2, 0xF5, 0xF9);
  COLORREF text_color = RGB(0x16, 0x23, 0x3C);
